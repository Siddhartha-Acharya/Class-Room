                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="Library.jsp">Library Profile</a></li>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xl-9">
                        ...
                        <div class="card">
                            <div class="card-body">
                               ...
                               <div class="media align-items-center mb-4">
                                    <a href="Leditprofile.jsp"><img class="mr-3" src="data:image/jpg;base64,${pojo3.base64Image}"  width="80" height="80" alt=""></a>
                                    <div class="media-body">
                                        <h3 class="mb-0"><c:out value="${pojo3.name}"/></h3>
                                ...
                                <div class="row mb-5">
                                    <div class="col">
                                        <div class="card card-profile text-center">
                                            ...
                                            <p class="text-muted px-4"><c:out value="${pojo3.name}"/></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="card card-profile text-center">
                                            ...
                                            <p class="text-muted"><c:out value="${pojo3.email}"/></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="card card-profile text-center">
                                            ...
                                            <p class="text-muted"><c:out value="${pojo3.number}"/></p>
                                        </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <h4>About Teacher</h4>
                                <p class="text-muted"><c:out value="${pojo3.name}"/> is the teacher from <c:out value="${pojo3.number}"/> depertment of SVIST with great exprience in his/her core field  </p>
