...
<head>
    ...
    <title>SVIST REGISTRATION</title>
    <!-- Favicon icon -->
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <form action="StudentRegisterController" " method="post" class="mt-5 mb-5 login-input">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="registration_no"   class="form-control"  placeholder="Registration_No" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="semail"   class="form-control"  placeholder="Email" required>
                                    </div>
                                    <div class="form-group">
