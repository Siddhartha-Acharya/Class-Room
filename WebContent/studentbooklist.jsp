                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <%@page import="Com.Controller.RequestfetchController"%>
                                    <%@page import="Com.Dao.RequestfetchDao" %>
                                    <%@page import="java.util.ArrayList"%>
                                    <%@page import="Com.Model.Requestfetchpojo"%>
                                    <% ArrayList<Requestfetchpojo> list=(ArrayList<Requestfetchpojo>) session.getAttribute("request"); %>
                                        ...
                                        <td><%=list.get(i).getRegistration_no() %></td>
                                         <td><%=list.get(i).getBook_name() %></td>
                                         <td><%=list.get(i).getBook_id() %></td>
                                         <th><%=list.get(i).getTranjection_id() %></th>
                                        ...
                                        <td>
                                        <button><a href="book.jsp?id=<%=list.get(i).getTranjection_id() %>">Process</a></button>
                                        </td>
                                        </tr>
                                        <%} %>
                                        </tbody>
